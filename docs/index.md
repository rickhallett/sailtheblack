...
2. **Core Issue: Shore Road Traffic Management**
   - 2.1. [The Survey](core-issue/black-flag--02-core-issue.md#21-the-survey)
     - 2.1.1. [Perceived Bias and Flaws](core-issue/black-flag--02-core-issue.md#211-perceived-bias-and-flaws)
     - 2.1.2. [Length and Engagement](core-issue/black-flag--02-core-issue.md#212-length-and-engagement)
     - 2.1.3. [Mandatory Questions & "Hack"](core-issue/black-flag--02-core-issue.md#213-mandatory-questions--hack)
   - 2.2. [Proposed Changes (One-way vs. Two-way traffic)](core-issue/black-flag--02-core-issue.md#22-proposed-changes-one-way-vs-two-way-traffic)
...
3. **[Campaign Strategy & Tactics](strategy/black-flag--03-tactics-strategy.md)**
   - 3.1. Overall Goal: Maintain Two-Way Traffic / Oppose Closure
   - 3.2. [Target Audiences](strategy/black-flag--03-tactics-strategy.md#32-target-audiences)
     - 3.2.1. [Young Population](strategy/black-flag--03-tactics-strategy.md#321-young-population)
     - 3.2.2. [General Residents](strategy/black-flag--03-tactics-strategy.md#322-general-residents)
     - 3.2.3. [Local Councillors](strategy/black-flag--03-tactics-strategy.md#323-local-councillors)
     - 3.2.4. [Dorset County Council](strategy/black-flag--03-tactics-strategy.md#324-dorset-county-council)
     - 3.2.5. [Influencers (e.g., Jonathan Ross, Russell Brand - hypothetical)](strategy/black-flag--03-tactics-strategy.md#325-influencers-eg-jonathan-ross-russell-brand---hypothetical)
...
4. **[Council & Authority Interaction](authority/black-flag--04-authority.md)**
...
5. **[Tools & Resources Discussed](tools/black-flag--05-tools-resources.md)**
...
6. **[Philosophical & Broader Themes](analysis/black-flag--06-broader-themes.md)**
...
7. **[Actionable Items & Next Steps (Inferred)](strategy/black-flag--07-actionables.md)**
...
- **2.1. The Survey**
  ...
  - **2.1.3. Mandatory Questions & "Hack":** A key discovery is that only three questions (1, 24, and 26, the latter specifically about the road) are mandatory (00:00:47 - 00:01:00). This allows the survey to be completed in approximately [20 seconds](core-issue/black-flag--02-core-issue.md#213-mandatory-questions--hack) (01:00:00, 01:11:10). This ["hack"](strategy/black-flag--03-tactics-strategy.md#331-flyers-cheap-simple-scan-me-qr-code) becomes a central part of the campaign strategy to encourage participation from those solely concerned with the road issue.

- **2.2. Proposed Changes (One-way vs. Two-way traffic):** The options being considered include making Shore Road one-way or potentially closing it, versus maintaining the current two-way traffic ([Option 3](core-issue/black-flag--02-core-issue.md#22-proposed-changes-one-way-vs-two-way-traffic) in the survey). The Speaker is campaigning for Option 3 (00:01:15). The one-way system is predicted to cause "gridlock" if people are stopping to pick up/drop off (01:24:30).

- **2.3. Impact on Local Community**
  - **2.3.1. Young Population/Drivers:** This group is seen as crucial and currently [underrepresented](strategy/black-flag--03-tactics-strategy.md#321-young-population) (01:48:30). They are perceived as wanting to keep the road open for driving and parking on the seafront (00:01:55 - 00:02:05). The campaign aims to energize them by highlighting what they stand to lose (01:01:00).
...
- **3.3. Communication & Messaging**
  - **3.3.1. [Flyers (Cheap, Simple, "Scan Me" QR Code)](strategy/black-flag--07-actionables.md#72-design-and-print-flyers-with-qr-code):** A primary tactic is to produce and distribute cheap, simple flyers with a clear call to action: "Campaign: Keep Swanage Two-Way Traffic / Shore Road Two-Way Traffic," instructing people to answer the three key questions and choose [Option 3](core-issue/black-flag--02-core-issue.md#22-proposed-changes-one-way-vs-two-way-traffic), using a [QR code](tools/black-flag--05-tools-resources.md#53-qr-codes) for easy access to the survey (00:03:05 - 00:03:33).
  - **3.3.2. Social Media ([Facebook Page](strategy/black-flag--07-actionables.md#71-create-facebook-page--social-media-presence), [Linktree](tools/black-flag--05-tools-resources.md#52-linktree-social-media-hub)):** Creating a dedicated Facebook page for the campaign is a priority (00:03:39). Linktree is suggested by the Other Speaker as a way to consolidate social media links (02:56:30). The plan is to share the message widely and encourage others to share.
  ...
  - **3.3.5. Key Slogans/Messages Discussed**
    ...
    - ["20 seconds, not 20 minutes"](core-issue/black-flag--02-core-issue.md#213-mandatory-questions--hack) (referring to the survey hack) (01:00:00)
...
- **3.4. Data & Evidence Gathering**
  - **3.4.1. [Sentiment Analysis of Survey](strategy/black-flag--07-actionables.md#73-conduct-sentiment-analysis-of-the-survey):** The Other Speaker will assist with this to demonstrate bias (00:02:36).
...
- **8.1. [The Survey's "Hack"](core-issue/black-flag--02-core-issue.md#213-mandatory-questions--hack):** The realization that only 3 mandatory questions need answering, reducing completion time to ~20 seconds, is a significant tactical advantage.
- **8.2. [The Council's Survey is perceived as biased](core-issue/black-flag--02-core-issue.md#211-perceived-bias-and-flaws):** Strong belief that the survey is designed to favor a particular outcome and discourage broad participation.
...
- **8.5. [Power of framing](strategy/black-flag--03-tactics-strategy.md#334-sentiment--tone):** The issue can be effectively framed as a loss of freedom, a denial of democratic voice, and an injustice, resonating with different groups.
- **8.6. Limited timeframe:** The June 29th deadline for the survey creates urgency.
- **8.7. [Linktree potential](tools/black-flag--05-tools-resources.md#52-linktree-social-media-hub):** A useful tool for centralizing social media efforts.
